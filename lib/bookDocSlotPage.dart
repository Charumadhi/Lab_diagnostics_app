...
import 'paymentConsultation.dart';
import 'main.dart';

class BookDocSlotPage extends StatefulWidget {
  // final Test test;
  // final String labUniqueId; // Add labUniqueId parameter
  final String patientId;
  final String meduniqid;

  BookDocSlotPage({required this.patientId,required this.meduniqid});

  @override
  _BookSlotPageState createState() => _BookSlotPageState();
}

class _BookSlotPageState extends State<BookDocSlotPage> {
        ...
        child: Column(
          children: [
            ...
            Wrap(
              ...
              runSpacing: 10.0,
              children: [
                //_timeSlotButton('09:00 am'),
                //_timeSlotButton('10:00 am'),
                //_timeSlotButton('01:00 pm'),
                //_timeSlotButton('02:00 pm'),
                //_timeSlotButton('04:00 pm'),
                _timeSlotButton('05:00 pm'),
                _timeSlotButton('05:30 pm'),
                _timeSlotButton('06:00 pm'),
                _timeSlotButton('06:30 pm'),
                _timeSlotButton('07:00 pm'),
                _timeSlotButton('07:30 pm'),
                _timeSlotButton('08:00 pm'),
              ],
            ),
