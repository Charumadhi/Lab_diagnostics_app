...
import 'about_us_patient.dart';
import 'labSearchPage.dart';
import 'patient_profile_page.dart';
import 'health_risk_detail_page.dart'; // Import the new page
import 'doctorsListPage.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';
import 'main.dart';
import 'bookedTestsDisplay.dart';
import 'bookDocAppDisplay.dart';
import 'reports_page.dart';

class HomePagePatient extends StatefulWidget {
  final String email;

  HomePagePatient({required this.email});
...
class _HomePagePatientState extends State<HomePagePatient> {
  ...
  String _patientUniqId = 'Unique Id';
  ...
  Future<void> fetchPatientDetails() async {
    try {
      final response = await http.get(Uri.parse('http://10.0.2.2:3000/getPatientDetails?email=${widget.email}'));

      if (response.statusCode == 200) {
        final data = json.decode(response.body);
        setState(() {
          _patientName = data['name'] ?? 'Patient';
          _patientUniqId = data['unique_id'] ?? 'Unique Id';
        });
      } else {
  ...
  void _navigateToProfile(BuildContext context) async {
    try {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => ProfilePatient(email: widget.email),
        ),
      );
    } catch (error) {
      print(error);
  ...
  void _navigateToLabSearch(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => LabSearchPage(patientId: _patientUniqId), // Pass patientId here
      ),
    );
  }
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ReportsPage(patientId: _patientUniqId),
                  ),
                );
            ...
            ListTile(
              ...
              title: Text('Labs'),
              onTap: () {
                _navigateToLabSearch(context); // Update to navigate to LabSearchPage
              },
            ),
            ListTile(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => BookedTestsPage(patientId: _patientUniqId),
                  ),
                );
                },
            ),
            ListTile(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => BookedAppointmentsPage(patientId: _patientUniqId),
                  ),
                );
                },
            ),
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'Welcome $_patientName, ($_patientUniqId)',
                  ...
                  HealthRisksWidget(),
                  SizedBox(height: 20),
                  DoctorCategoriesWidget(patientId: _patientUniqId),
                  SizedBox(height: 20),
                  _buildFooter(),
                ],
              ),
...
class DoctorCategoriesWidget extends StatelessWidget {
  final String patientId;
  DoctorCategoriesWidget({required this.patientId});

  final List<Map<String, String>> doctorCategories = [
    {'image': 'https://media.istockphoto.com/id/1399012277/vector/human-heart-3d-realistic-vector-isolated-on-white-background-anatomically-correct-heart-with.jpg?s=2048x2048&w=is&k=20&c=GvnPVk9hKGC7MygMcjfdN0X39UrdcoAp_tqtLVcZyPo=', 'label': 'Cardiologist'},
    {'image': 'https://my.clevelandclinic.org/-/scassets/images/org/health/articles/10978-skin', 'label': 'Dermatologist'},
    {'image': 'https://img.freepik.com/premium-photo/conceptual-image-with-neuron-cell-isolated-white_653449-2859.jpg?w=740', 'label': 'Neurologist'},
    {'image': 'https://img.freepik.com/free-psd/skull-figure-isolated_23-2151374244.jpg?t=st=1719731680~exp=1719735280~hmac=8088534b2c12d34acb0115caf56791a53d3ba78d1520ee6e1d7c833a91ff390f&w=826', 'label': 'Orthopedic'},
    {'image': 'https://img.freepik.com/premium-photo/happy-young-model-girl-posing-isolated_1871-1143.jpg?w=360', 'label': 'Pediatrician'},
    {'image': 'https://img.freepik.com/free-photo/depiction-human-brain-intellect_23-2150936617.jpg?t=st=1720244046~exp=1720247646~hmac=f27c8a68cf236a95759fc953e534b8cf46015113d60c0e93a297d9a9a844f0cc&w=740', 'label': 'Psychiatrist'},
    {'image': 'https://img.freepik.com/free-vector/human-liver-structure-organ-human-medical-science-health-internal_1284-42361.jpg?w=740&t=st=1719731180~exp=1719731780~hmac=522894a67fe18beda3456302ee0154033722346615499a7eae70b0d8fa379ec8', 'label': 'Hepatologist'},
    {'image': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQqH9shG6lR4EcRFHWKUeuF1036hNVNEFNXFg&s', 'label': 'Nephrologist'},
    {'image': 'https://img.freepik.com/free-vector/red-lungs-with-white-background-word-heart-it_1308-153031.jpg', 'label': 'Pulmonologist'},
    {'image': 'https://static.vecteezy.com/system/resources/previews/003/661/874/original/stomach-organ-human-free-vector.jpg', 'label': 'Gastroenterologist'},
    {'image': 'https://thumbs.dreamstime.com/b/hand-drawn-human-eye-white-background-art-illustration-black-pencil-drawing-217405921.jpg', 'label': 'Ophthalmologist'},
    {'image': 'https://thumbs.dreamstime.com/b/smiling-mouth-white-teeth-isolated-background-85920986.jpg', 'label': 'Dentist'},
  ];
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => DoctorsListPage(
                        specialization: doctorCategories[index]['label']!,
                        patientId: patientId,
                      ),
                    ),
                  );
