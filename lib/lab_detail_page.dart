...
class _LabSearchPageState extends State<LabSearchPage> {
  ...
  Future<void> _findLabsNearMe() async {
    ...
    try {
      ...
      final response = await http.get(Uri.parse('http://192.168.0.196:3000/nearby-labs?lat=$latitude&lon=$longitude'));
  ...
  Future<void> _searchLabs() async {
    ...
    try {
      final response = await http.get(Uri.parse('http://192.168.0.196:3000/search-labs?locality=$locality&city=$city&state=$state'));
