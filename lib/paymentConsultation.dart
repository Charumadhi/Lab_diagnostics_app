...
import 'dart:convert';
import 'appBookedPage.dart';

class PaymentConsultationPage extends StatelessWidget {
  //final Test test;
  ...
  Future<void> createAppointment(String otp) async {
    try {
      ...
      final response = await http.post(
        Uri.parse('http://10.0.2.2:3000/createDocAppointment'),
